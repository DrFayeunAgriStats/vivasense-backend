  ...
  const run = async () => {
    ...
    try {
      const data = await analyzeUpload({
        ...
        genotype_column: hideTreatmentSelector ? null : treatmentColumn,
        ...
        module: "anova",
        design_type: design, // Always send the correct design value
        treatment_column: hideTreatmentSelector ? null : treatmentColumn,
