    ...
    async def process_trait(trait: str):
        try:
            ...
            result_obj = AnovaTraitResult(
                ...
                diagnostic_observations=res.diagnostic_observations,
                diagnostic_plots=res.diagnostic_plots,
                residuals=res.residuals,
                fitted_values=res.fitted_values,
                standardized_residuals=res.standardized_residuals,
                cooks_distance=res.cooks_distance,
                outlier_summary=res.outlier_summary,
                mean_separation=res.mean_separation,
                main_plot_mean_separation=res.main_plot_mean_separation if is_sp else None,
